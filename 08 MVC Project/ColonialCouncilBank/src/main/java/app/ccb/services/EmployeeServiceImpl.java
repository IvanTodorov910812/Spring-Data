    ...
    public String importEmployees(String employees) {
        ...
        for (EmployeeImportDto employeeImportDto : employeeImportDtos) {
            ...
            Branch branchEntity = this.branchRepository
                    .findByName(employeeImportDto.getBranchName()).orElse(null);
    ...
    public String exportTopEmployees() {
        ...
        for (Employee employeeEntity : employeeEntities) {
            ...
            exportResult.append("Full Name: ")
                    .append(String.format("%s %s", employeeEntity.getFirstName(), employeeEntity.getLastName()))
                    .append(System.lineSeparator());
            //Salary field
            exportResult.append("Salary: ").append(String.format("%.2f", employeeEntity.getSalary()))
                    .append(System.lineSeparator());
            //Started On Field
            exportResult.append("Started On: ")
                    .append(String.valueOf(employeeEntity.getStartedOn()))
                    .append(System.lineSeparator());
            ...
            for (Client clientEntity : employeeEntity.getClients()) {
                ...
                exportResult.append(String.format(" %s", clientEntity.getFullName()))
                        .append(System.lineSeparator());
            }
